...
5_train_binary.py
------------------
Binary VQC — car_clean vs car_knocking only.

Simpler than 4-class:
    - only car samples from quantum_ready/
    - one measurement qubit instead of two
    - Z0 positive -> car_clean, Z0 negative -> car_knocking

Everything else identical to 5_train.py.

Run:
    python src/5_train_binary.py

Inputs:  quantum_ready/X_train.npy
         quantum_ready/X_test.npy
         quantum_ready/y_train.npy
         quantum_ready/y_test.npy

Outputs: trained_params_binary.npy
         training_log_binary.txt
"""
